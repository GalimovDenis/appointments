...
import com.appointments.commands.CmdAddEvent;
import com.appointments.commands.CmdRemoveEvent;
import com.appointments.commands.CmdSetEventStart;
import com.appointments.commands.IAppCommand;
...
public class AppCommandsTestAuto {
	...
	public void addRemoveExecRedo() {
		...
		IAppointmentEvent event = IEventBuilder.create().fillTestAppointment().buildAppointment();
	...
	private void addNEvents(ICalendars appCalendar, int NEvents) {
		...
		for (int i = 0; i < NEvents; i++) {
			...
			eventOne = IEventBuilder.create().fillTestAppointment().buildAppointment();

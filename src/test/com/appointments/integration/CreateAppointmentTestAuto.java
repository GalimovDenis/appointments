...
import com.appointments.net.client.appointments.RESTExchanger;
import com.appointments.util.TestUtil;
...
public class CreateAppointmentTestAuto {
	...
	public void testSingleCreation() throws URISyntaxException {
		...
		IAppointmentEvent eventToCreateI = IEventBuilder.create().fillTestAppointment(Attendee, Organizer)
				.buildAppointment();
	...
	public void testMultiCreation() throws URISyntaxException, InterruptedException {
		...
		for (int i = 0; i < CREATECOUNT; i++) {
			...
			TestUtil.createAppointmentTest(
					IEventBuilder.create().fillTestAppointment(Attendee, Organizer).buildAppointment(),

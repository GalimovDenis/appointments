...
public class Appointment implements IAppointmentEvent {
	...
	protected Appointment(Integer mutationID, LocalDateTime timestamp, UUID uid, LocalDateTime start, LocalDateTime end,
